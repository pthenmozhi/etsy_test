...
public class SearchSteps {
    ...
    public void the_result_should_get_displayed_from_the_drop_down_menu() throws Throwable {
        user.verify_search_result_for_drop_down_header();
    }

    @Then("^the result should get displayed from the icons search via API$")
    public void the_result_should_display_icon_search() throws Throwable {
        user.verify_result_for_Icon_Header();
    }
